...
progenomes_VER=2023-05-25
nr_euk_VER=2023-05-10
nr_VER=2024-08-25
refseq_VER=2024-08-14
fungi_VER=2024-08-16
viruses_VER=2024-08-15
plasmids_VER=2024-08-15
rvdb_VER=2024-12-20
# Two new dbs listed - can add later and update app UI to select them
# refseq_nr_VER=2024-08-13
# refseq_ref_VER=2024-08-14
...
if [ $# -eq 0 ] ; then
  ...
  echo "downloading: https://kaiju-idx.s3.eu-central-1.amazonaws.com/${progenomes_VER:0:4}/kaiju_db_progenomes_$progenomes_VER.tgz"
  mkdir -p /data/kaijudb/progenomes
  cd /data/kaijudb/
  curl -o kaiju_db_progenomes_$progenomes_VER.tgz https://kaiju-idx.s3.eu-central-1.amazonaws.com/${progenomes_VER:0:4}/kaiju_db_progenomes_$progenomes_VER.tgz
  ...
  echo "downloading: https://kaiju-idx.s3.eu-central-1.amazonaws.com/${nr_VER:0:4}/kaiju_db_nr_$nr_VER.tgz"
  mkdir -p /data/kaijudb/nr
  cd /data/kaijudb/
  curl -o kaiju_db_nr_$nr_VER.tgz https://kaiju-idx.s3.eu-central-1.amazonaws.com/${nr_VER:0:4}/kaiju_db_nr_$nr_VER.tgz
  ...
  echo "downloading: https://kaiju-idx.s3.eu-central-1.amazonaws.com/${nr_euk_VER:0:4}/kaiju_db_nr_euk_$nr_euk_VER.tgz"
  mkdir -p /data/kaijudb/nr_euk
  cd /data/kaijudb/
  curl -o kaiju_db_nr_euk_$nr_euk_VER.tgz https://kaiju-idx.s3.eu-central-1.amazonaws.com/${nr_euk_VER:0:4}/kaiju_db_nr_euk_$nr_euk_VER.tgz
  ...
  echo "downloading: https://kaiju-idx.s3.eu-central-1.amazonaws.com/${viruses_VER:0:4}/kaiju_db_viruses_$viruses_VER.tgz"
  mkdir -p /data/kaijudb/viruses
  cd /data/kaijudb/
  curl -o kaiju_db_viruses_$viruses_VER.tgz https://kaiju-idx.s3.eu-central-1.amazonaws.com/${viruses_VER:0:4}/kaiju_db_viruses_$viruses_VER.tgz
  ...
  echo "downloading: https://kaiju-idx.s3.eu-central-1.amazonaws.com/${plasmids_VER:0:4}/kaiju_db_plasmids_$plasmids_VER.tgz"
  mkdir -p /data/kaijudb/plasmids
  cd /data/kaijudb/
  curl -o kaiju_db_plasmids_$plasmids_VER.tgz https://kaiju-idx.s3.eu-central-1.amazonaws.com/${plasmids_VER:0:4}/kaiju_db_plasmids_$plasmids_VER.tgz
  ...
  echo "downloading: https://kaiju-idx.s3.eu-central-1.amazonaws.com/${rvdb_VER:0:4}/kaiju_db_rvdb_$rvdb_VER.tgz"
  mkdir -p /data/kaijudb/rvdb
  cd /data/kaijudb/
  curl -o kaiju_db_rvdb_$rvdb_VER.tgz https://kaiju-idx.s3.eu-central-1.amazonaws.com/${rvdb_VER:0:4}/kaiju_db_rvdb_$rvdb_VER.tgz
  ...
  echo "downloading: https://kaiju-idx.s3.eu-central-1.amazonaws.com/${fungi_VER:0:4}/kaiju_db_fungi_$fungi_VER.tgz"
  mkdir -p /data/kaijudb/fungi
  cd /data/kaijudb/
  curl -o kaiju_db_fungi_$fungi_VER.tgz https://kaiju-idx.s3.eu-central-1.amazonaws.com/${fungi_VER:0:4}/kaiju_db_fungi_$fungi_VER.tgz
